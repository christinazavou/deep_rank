...
os.system("python qr/main.py --corpus /home/christina/Documents/Thesis/data/askubuntu/texts_raw_fixed.txt --train "
          "/home/christina/Documents/Thesis/data/askubuntu/train_random.txt --test /home/"
          ...
          "--hidden_dim 280 --dropout 0.2 --reweight 0 --average 1 "
          "--layer cnn --batch_size 40 --save_dir /media/christina/Data/Thesis/models/askubuntu/mine_qr/all_train/"
          "CNN280win3drop20rew0meanpool/_with_init_weights/run1 > /media/christina/Data/Thesis/models/askubuntu/"
          "mine_qr/all_train/CNN280win3drop20rew0meanpool/_with_init_weights/run1/train.txt")
...
os.system("python qr/main.py --corpus /home/christina/Documents/Thesis/data/askubuntu/texts_raw_fixed.txt --train "
          ...
          "--hidden_dim 280 --dropout 0.2 --reweight 0 --average 1 "
          "--layer cnn --batch_size 40 --save_dir /media/christina/Data/Thesis/models/askubuntu/mine_qr/all_train/"
          "CNN280win3drop20rew0meanpool/_with_init_weights/run2 > /media/christina/Data/Thesis/models/askubuntu/"
          "mine_qr/all_train/CNN280win3drop20rew0meanpool/_with_init_weights/run2/train.txt")
