...
class Model(object):
    ...
    def evaluate(self, data, sess):
        ...
        def eval_batch(titles, bodies, labels, features):
        ...
        for idts, idbs, id_labels, batch_features in data:
            cur_scores = eval_batch(idts, idbs, id_labels, batch_features)
    ...
    def train_model(self, train_batches, dev=None, test=None, assign_ops=None):
        with tf.Session() as sess:
            ...
            for epoch in xrange(max_epoch):
                ...
                def train_batch(titles, bodies, pairs, features):
                ...
                for i in xrange(N):
                    ...
                    cur_step, cur_loss, cur_cost = train_batch(idts, idbs, idps, batch_features)
    ...
    def save(self, sess, path, step):
        ...
        params = tf.trainable_variables()  # todo: self.dnn_vars + self.linear_vars
        params_dict = {}
        for param in params:
...
def create_batches(ids_corpus, data, batch_size, padding_id, f1_vectors, f2_vectors, perm=None, pad_left=True):
    ...
    for u in xrange(N):
        if u % 100 == 0:
            print 'u is ', u
        if u == 15000:  # TAKES TOO LONG..TEST  8000
            break
        i = perm[u]
